...
<head>
    <meta charset="utf-8">
    <title>Category Review — {{ $document['meta']['entity_code'] ?? '' }}</title>
    <style>
        body {
...
<table class="overview">
    <tr>
        ...
        <td class="overview-body">
            ...
            <p class="facts">
                <strong>Code:</strong> {{ ContentAuditPdfLayout::summaryValue($document, 'Category Code') ?? '—' }}
...
<p class="footer">Agricart ERP — Category review report</p>
</body>
</html>
